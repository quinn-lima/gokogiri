...
import (
	"github.com/quinn-lima/gokogiri/html"
...
found in the github.com/quinn-lima/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
